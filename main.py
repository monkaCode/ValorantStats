...
async def rounds(ctx, arg1=None):
    if arg1 == None:
        ...
        await ctx.send(":flag_ma: **BIND**         ATT Win%: **" + data[0][2] + "**   |   DEF Win%: **" + data[1][2] + "**   |   Games: **" + data[0][1] + "**\n:flag_bt: **HAVEN**    ATT Win%: **" + data[4][2] + "**   |   DEF Win%: **" + data[5][2] + "**   |   Games: **" + data[4][1] + "**\n:flag_jp: **SPLIT**        ATT Win%: **" + data[8][2] + "**   |   DEF Win%: **" + data[9][2] + "**   |   Games: **" + data[8][1] + "**\n:flag_it: **ASCENT**   ATT Win%: **" + data[12][2] + "**   |   DEF Win%: **" + data[13][2] + "**   |   Games: **" + data[12][1] + "**\n:flag_ru: **ICEBOX**    ATT Win%: **" + data[16][2] + "**   |   DEF Win%: **" + data[17][2] + "**   |   Games: **" + data[16][1] + "**\n:flag_tt: **BREEZE**    ATT Win%: **" + data[20][2] + "**   |   DEF Win%: **" + data[21][2] + "**   |   Games: **" + data[20][1] + "**")
