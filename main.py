...
async def rounds(ctx, arg1=None):
    if arg1 == None:
        ...
        await ctx.send(":flag_ma: **BIND**         ATT Win%: **" + data[0][2] + "**   |   DEF Win%: **" + data[1][2] + "**   |   Games: **" + data[0][1] + "**\n:flag_bt: **HAVEN**    ATT Win%: **" + data[3][2] + "**   |   DEF Win%: **" + data[4][2] + "**   |   Games: **" + data[3][1] + "**\n:flag_jp: **SPLIT**        ATT Win%: **" + data[6][2] + "**   |   DEF Win%: **" + data[7][2] + "**   |   Games: **" + data[6][1] + "**\n:flag_it: **ASCENT**   ATT Win%: **" + data[9][2] + "**   |   DEF Win%: **" + data[10][2] + "**   |   Games: **" + data[9][1] + "**\n:flag_ru: **ICEBOX**    ATT Win%: **" + data[12][2] + "**   |   DEF Win%: **" + data[13][2] + "**   |   Games: **" + data[12][1] + "**\n:flag_tt: **BREEZE**    ATT Win%: **" + data[15][2] + "**   |   DEF Win%: **" + data[16][2] + "**   |   Games: **" + data[15][1] + "**")
