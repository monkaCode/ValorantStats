...
async def rounds(ctx, arg1=None):
    if arg1 == None:
        ...
        await ctx.send(":flag_ma: **BIND**         ATT Win%: **" + data[1][2] + "**   |   DEF Win%: **" + data[0][2] + "**   |   Games: **" + data[0][1] + "**\n:flag_bt: **HAVEN**    ATT Win%: **" + data[5][2] + "**   |   DEF Win%: **" + data[4][2] + "**   |   Games: **" + data[4][1] + "**\n:flag_jp: **SPLIT**        ATT Win%: **" + data[9][2] + "**   |   DEF Win%: **" + data[8][2] + "**   |   Games: **" + data[8][1] + "**\n:flag_it: **ASCENT**   ATT Win%: **" + data[13][2] + "**   |   DEF Win%: **" + data[12][2] + "**   |   Games: **" + data[12][1] + "**\n:flag_ru: **ICEBOX**    ATT Win%: **" + data[17][2] + "**   |   DEF Win%: **" + data[16][2] + "**   |   Games: **" + data[16][1] + "**\n:flag_tt: **BREEZE**    ATT Win%: **" + data[21][2] + "**   |   DEF Win%: **" + data[20][2] + "**   |   Games: **" + data[20][1] + "**")
    ...
    if int(rw) + int(rl) > 32:
        ...
        if error == False:
            ...
            for x in range(len(player_str)):
                stats += "**Player:** " + player_str[x] + "   |   **Agent:** " + player_agent_str[x] + "   |   **KDA:** " + str(game_player[x][2]) + " / " + str(game_player[x][3]) + " / " + str(game_player[x][4]) + "\n"
                print(stats)
